...
import top.mc506lw.rebar.endfield_industry.recipes.PlanterRecipe
...
class PlanterController : PowerConsumerDevice,
    ...
    override fun tick() {
        ...
        val recipe = PlanterRecipe.RECIPE_TYPE.recipes.find { recipe ->
